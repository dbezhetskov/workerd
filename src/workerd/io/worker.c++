...
// The C++ decorator template for console.* methods. Declared here (ahead of the Isolate
// constructor, which registers each instantiation as a V8 external reference) and defined later
// alongside handleLog.
